            ...
            <div class="content2">
            	<table width="100%" border="1">
                      ...
                      <tr>
                        ...
                        <td><?php echo $district[$row->community_id]->name.' '.$block[$row->community_id]->name; ?></td>
                        <td><?php echo $community[$row->community_id]->name; ?></td>
                        ...
                        <td><a href="<?php echo base_url('/admin/shop/edit_shop?shop_id=' .$row->shop_id); ?>">编辑</a>
                        	...
                        	<a onclick="return del_alert()" href="<?php echo base_url('/admin/shop/del_shop?shop_id=' .$row->shop_id); ?>">删除</a>
                        </td>
                      </tr>
                      <?php endforeach;?>
                 </table>
