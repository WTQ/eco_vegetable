...
<div class="manager">
	<div class="leftmenu">
        ...
        <div class="menu">
        	<div class="menu1 menu1_checked">
            	<div id="image1"></div>
                <div class="word">系统首页</div>
                 <div class="cl"></div>
            </div>
            <div class="menu1"><a href="system_index.html">
            	<div id="image2"></div>
             ...
             <div class="menu1"><a href="system_index.html">
            	<div id="image5"></div>
                <div class="word">统计分析</div>
                <div class="cl"></div></a>
            </div>
            <div class="menu1"><a href="system_index.html">
            	<div id="image6"></div>
                <div class="word">广告管理</div>
                <div class="cl"></div></a>
            </div>
             <div class="menu1"><a href="system_index.html">
            	<div id="image7"></div>
    ...
    <div class="right">
        ...
        <div class="content">
            ...
            <div class="content2">
            	<table width="100%" border="1" height="328">
                      <tr>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
