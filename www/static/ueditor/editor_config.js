...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"../../../admin/attachment/imageup"             //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:URL+"../../admin/attachment/scrawup"           //涂鸦上传地址
        ,scrawlPath:URL_UPLOAD + ""                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"../../admin/attachment/fileup"               //附件上传提交地址
        ,filePath:URL_UPLOAD + ""                    //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"../../admin/attachment/getremoteimage"   //处理远程图片抓取的地址
        ,catcherPath:URL_UPLOAD + ""                   //图片修正地址，同imagePath
        //,catchFieldName:"upfile"                   //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
        //,separater:'ue_separate_ue'               //提交至后台的远程图片地址字符串分隔符
        //,localDomain:[]                            //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost

        //图片在线管理配置区
        ,imageManagerUrl:URL + "../../admin/attachment/imagemanager"       //图片在线管理的处理地址
        ,imageManagerPath:URL_UPLOAD + ""                                     //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: URL +"../../admin/attachment/imageup" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: URL_UPLOAD + "" 
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:URL + "../../admin/attachment/imageup"             //word转存提交地址
        ,wordImagePath:URL_UPLOAD + ""                       //
